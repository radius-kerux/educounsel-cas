 ...
 *
 */
class payment_mainController extends Spine_SuperController implements Spine_MainInterface
{

	public function main()
	{
		$this->displayPhtml('main_content', 'payment/main');
		$this->includeInPageScript( 'local_bottom_script', 'payment/js/local_bottom_script.js' );
	}
